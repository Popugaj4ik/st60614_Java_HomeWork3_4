package lv.tsi.practice2.activity01;
...
public class Transport {
	...
	public String toString() {
		return "Id:" + id + " cons:" + consumption + "l/100km," + " tank:" + tankSize + "l," + " fuel:" + String.format(Locale.US, "%.2f", getFuelInTank()) + "l";
	}
	...
	public String move(Road road) {
		...
		float necesarryFuel = road.getDistance() * ( consumption / 100 );
		if(fuelInTank < necesarryFuel){
			return "Cannot move on " + road + ". Necessary fuel:" + String.format(Locale.US,"%.2f", necesarryFuel) + "l, fuel in tank:" + String.format(Locale.US,"%.2f", fuelInTank) + "l";
		}
		else{
			fuelInTank-=necesarryFuel;
